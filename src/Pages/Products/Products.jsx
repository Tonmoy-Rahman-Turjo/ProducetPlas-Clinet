...
const Products = () => {
  ...
  const indexOfLastProduct = currentPages * productsPerPage;
    ...
    <div className="bg-[#3ec8f1] py-20">
      ...
      <div className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
        {currentProducts?.map((product) => (
          <div key={product._id} className="bg-[#47d634af] hover:bg-red-500 p-2 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
      ...
      <div className="flex justify-center">
        {Array.from({
          ...
          <button
            ...
            className={`px-6 py-2 text-3xl mx-2 bg-white rounded-md hover:bg-gray-300 focus:outline-none ${currentPages === index + 1 ? "bg-white" : ""}`}
          >
            {index + 1}
          </button>
        ))}
