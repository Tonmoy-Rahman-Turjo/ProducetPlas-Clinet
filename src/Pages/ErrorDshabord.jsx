...
const ErrorDshabord = () => {
    ...
    <Link to="/deshbord"> <button className=" btn w-full px-6 mb-4 text-white font-bold text-2xl btn-primary text-center  ">Go Back</button></Link>
    </div>
      </div>
        </div>
    );
